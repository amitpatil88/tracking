...
CREATE TABLE USER_LOGIN_TOKEN(
    USER_LOGIN_TOKEN_ID INT NOT NULL AUTO_INCREMENT,
    USER_ID INT NOT NULL,
    SECURED_KEY VARCHAR(50) UNIQUE NOT NULL,
    LAST_REQUEST_RECEIVED DATETIME NOT NULL,
    IS_TOKEN_EXPIRED CHAR(1) NOT NULL,
    PRIMARY KEY (USER_LOGIN_TOKEN_ID),
    FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID)
);
